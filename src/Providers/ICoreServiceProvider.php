...
class ICoreServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app['config']->set('auth.providers.users.model', $this->app['config']->get('icore.auth.providers.users.model'));

        $this->app['config']->set('cache.stores.tfile', [
			'driver' => 'tfile',
			'path'   => storage_path('framework/cache/data')
		]);

        $this->app['config']->set('database.connections.mysql.collation', $this->app['config']->get('icore.database.connections.mysql.collation'));
        ...
        $this->app['config']->set('services.twitter', [
        ...
        $this->app->register(\N1ebieski\ICore\Providers\ConfigServiceProvider::class);
        $this->app->register(\N1ebieski\ICore\Providers\AppServiceProvider::class);
        $this->app->register(\N1ebieski\ICore\Providers\AuthServiceProvider::class);
        $this->app->register(\N1ebieski\ICore\Providers\EventServiceProvider::class);
        $this->app->register(\N1ebieski\ICore\Providers\RouteServiceProvider::class);
        $this->app->register(\N1ebieski\ICore\Providers\MacroServiceProvider::class);
        $this->app->register(\N1ebieski\ICore\Providers\ViewServiceProvider::class);
        $this->app->register(\N1ebieski\ICore\Providers\ScheduleServiceProvider::class);
    ...
    public function boot()
    {
        ...
        $this->publishes([
            __DIR__ . '/../../public' => public_path('vendor/icore'),
        ], 'icore.public');
