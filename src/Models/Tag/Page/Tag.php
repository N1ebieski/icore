...
namespace N1ebieski\ICore\Models\Tag\Page;

use Illuminate\Support\Facades\Config;
use N1ebieski\ICore\Models\Tag\Tag as BaseTag;
use Illuminate\Database\Eloquent\Casts\Attribute;
use Illuminate\Database\Eloquent\Relations\MorphToMany;
use N1ebieski\ICore\Database\Factories\Tag\Page\TagFactory;

/**
 * N1ebieski\ICore\Models\Tag\Page\Tag
 *
 ...
 * @property-read \Illuminate\Database\Eloquent\Collection|\N1ebieski\ICore\Models\Page\Page[] $morphs
 * @property-read int|null $morphs_count
 * @method static Builder|Tag byName(string $value)
 * @method static \N1ebieski\ICore\Database\Factories\Tag\Page\TagFactory factory(...$parameters)
...
class Tag extends BaseTag
{
    ...
    public function morphs(): MorphToMany
    {
        ...
        return $this->morphedByMany(\N1ebieski\ICore\Models\Page\Page::class, 'model', $table, 'tag_id');
    }
