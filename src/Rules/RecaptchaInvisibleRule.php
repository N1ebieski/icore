...
use N1ebieski\ICore\Http\Clients\Google\Recaptcha\Invisible\RecaptchaClient;

class RecaptchaInvisibleRule implements Rule, Stringable
{
    /**
    ...
    public function __construct(
        protected Lang $lang,
        protected RecaptchaClient $client
    ) {
        $this->lang = $lang;
        $this->client = $client;
    }
