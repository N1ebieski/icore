jQuery(document).on('click', '.statusComment, .status-comment', function (e) {
    e.preventDefault();
    ...
    jQuery.ajax({
        ...
        success: function (response) {
            ...
            if (response.status == 1) {
                ...
                $row.find('button.answer').prop('disabled', false);
                ...
                $.each(response.ancestors, function (key, value) {
                    ...
                    if ($rowAncestor.length) {
                        ...
                        $rowAncestor.find('button.answer').prop('disabled', false);
            ...
            if (response.status == 0) {
                ...
                $row.find('button.answer').prop('disabled', true);
                ...
                $.each(response.descendants, function (key, value) {
                    ...
                    if ($rowDescendant.length) {
                        ...
                        $rowDescendant.find('button.answer').prop('disabled', true);
