    ...
    <form class="mb-3" method="post" action="{{ route('admin.post.update_full', ['post' => $post->id]) }}" id="editFullPost">
        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                ...
                <div class="form-group">
                    <label for="category">
                        {{ trans('icore::categories.categories') }} <i data-toggle="tooltip" data-placement="top" title="{{ trans('icore::categories.categories_tooltip', ['max_categories' => $max_categories]) }}" class="far fa-question-circle"></i>
                    </label>
                    <div id="category">
                        ...
                        class="position-relative">
                            <div class="input-group">
                                <input type="text" class="form-control border border-right-0 @isValid('category')" placeholder="{{ trans('icore::categories.search_categories') }}">
