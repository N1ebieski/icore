    ...
    <div class="col my-auto d-flex justify-content-between">
        ...
        @endcan
                <ul class="list-unstyled mb-0 pb-0 flex-grow-1">
                    <li class="mb-3 mt-1">
                        <div class="progress">
                            <div 
                                class="progress-bar bg-success progress-bar-striped {{ ($mailing->status === 1) ? 'progress-bar-animated' : '' }}"
                                role="progressbar" 
                            ...
                            ></div>
                            <div 
                                class="progress-bar bg-danger progress-bar-striped {{ ($mailing->status === 1) ? 'progress-bar-animated' : '' }}"
                                role="progressbar" 
        ...
        <div class="text-right ml-3">
            <div class="responsive-btn-group">
                ...
                <a 
                    class="btn btn-primary align-bottom {{ $mailing->status == 1 ? 'disabled' : '' }}"
                    href="{{ route('admin.mailing.edit', [$mailing->id]) }}" 
                    role="button" 
                    target="_blank"
                    rel="noopener"
