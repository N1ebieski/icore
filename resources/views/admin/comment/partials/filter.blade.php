<form data-route="{{ route('admin.comment.'.$model->poli.'.index') }}" id="filter">
    <div class="d-flex flex-wrap position-relative">
        <div class="mb-3 mr-auto">
            ...
            <a href="{{ route('admin.comment.'.$model->poli.'.index') }}" class="badge badge-dark">{{ trans('icore::default.clear') }}</a>&nbsp;
            @endif
        </div>
