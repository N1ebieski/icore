<form method="post" data-route="{{ route('admin.link.update', [$link->id]) }}" data-id="{{ $link->id }}">
    <div class="form-group">
        <label for="name">{{ trans('icore::links.name') }}:</label>
        <input type="text" value="{{ $link->name }}" name="name"
        id="name" class="form-control">
    </div>
    <div class="form-group">
        <label for="url">{{ trans('icore::links.url') }}:</label>
        <input type="text" value="{{ $link->url }}" name="url"
    ...
    <div class="form-group">
        <div class="custom-control custom-checkbox">
            <input type="checkbox" class="custom-control-input" id="delete_img" name="delete_img">
            <label class="custom-control-label" for="delete_img">{{ trans('icore::links.delete_img') }}</label>
        </div>
    </div>
    @endif
    <div class="form-group">
        ...
        <div id="category">
            <div id="categoryOptions">
                ...
                => $link->categories, 'checked' => true])
            </div>
            <div id="searchCategory" data-route="{{ route("admin.category.{$link->type}.search") }}" data-max=""
