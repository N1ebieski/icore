<form data-route="{{ route('admin.tag.index') }}" id="filter">
    <div class="d-flex flex-wrap position-relative">
        <div class="mb-3 mr-auto">
            <span class="badge badge-primary">
                {{ trans('icore::filter.items') }}: {{ $tags->total() }}
            </span>
            ...
            <div class="form-inline d-flex flex-nowrap">
                ...
                <div class="form-group col-xs-4 mr-2">
                    ...
                    >
                        ...
                        <option 
                            value="sum|desc"
                            {{ ($filter['orderby'] == 'sum|desc') ? 'selected' : '' }}
                        >
                            {{ mb_strtolower(trans('icore::tags.sum')) }} {{ trans('icore::filter.desc') }}
                        </option>
                        <option 
                            value="sum|asc"
                            {{ ($filter['orderby'] == 'sum|asc') ? 'selected' : '' }}
                        >
                            {{ mb_strtolower(trans('icore::tags.sum')) }} {{ trans('icore::filter.asc') }}
                        </option>                            
                    </select>
                </div>
                <div class="form-group col-xs-4">
