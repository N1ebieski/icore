            ...
            <div class="col-lg-9 form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="{{ $isTheme('dark', 'trumbowyg-dark') }}">
                        ...
                        rows="10" id="content_html" data-lang="{{ config('app.locale') }}">{{ old('content_html', $page->content_html) }}</textarea>
                ...
                <div class="form-group">
                    ...
                    value="{{ old('tags', $page->tagList) }}" placeholder="{{ trans('icore::pages.tags.placeholder') }}" 
