...
<li class="breadcrumb-item active" aria-current="page">{{ trans('icore::profile.route.edit_socialite') }}</li>
@endsection
        ...
        <ul class="list-unstyled my-auto mb-0 pb-0">
            <li>
                <span class="text-primary">
                    <i class="fab fa-{{ $user_socialite->provider_name }}"></i> {{ ucfirst($user_socialite->provider_name) }}
                </span>
            </li>
        </ul>
