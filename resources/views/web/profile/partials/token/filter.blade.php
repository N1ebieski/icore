<form data-route="{{ route("web.profile.tokens") }}" id="filter">
    <div class="d-flex flex-wrap position-relative">
        <div class="mb-3 mr-auto">
            <span class="badge badge-primary">
                {{ trans('icore::filter.items') }}: {{ $tokens->total() }}
            </span>
                ...
                <div class="form-group col-xs-4 mr-2">
                    ...
                    >
                        ...
                        <option 
                            ...
                            {{ ($filter['orderby'] == 'expired_at|desc') ? 'selected' : '' }}
                        >
                            {{ mb_strtolower(trans('icore::tokens.expired_at')) }} {{ trans('icore::filter.desc') }}
                        </option>
                        <option 
                            value="expired_at|asc"
                            {{ ($filter['orderby'] == 'expired_at|asc') ? 'selected' : '' }}
                        >
                            {{ mb_strtolower(trans('icore::tokens.expired_at')) }} {{ trans('icore::filter.asc') }}
                        </option>
                        <option 
                            value="title|desc"
    ...
    @include('icore::web.profile.partials.token.filter_filter')
</form>
